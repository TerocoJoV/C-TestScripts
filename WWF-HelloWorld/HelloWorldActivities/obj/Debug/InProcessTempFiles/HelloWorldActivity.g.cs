...
namespace HelloWorldActivities {
    ...
    public partial class HelloWorldActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(HelloWorldActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(HelloWorldActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(HelloWorldActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".HelloWorldActivity.g.xaml") || resource.Equals("HelloWorldActivity.g.xaml"))) {
                    return resource;
                }
            }
